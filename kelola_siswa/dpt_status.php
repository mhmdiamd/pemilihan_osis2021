<?php
    ...
    <?php
    // $sql = "SELECT * FROM paslon WHERE id_paslon != 1 and != 2";
    // $eksekusi = mysqli_query($konek, $sql);

	$sql1 = "SELECT * FROM dpt INNER JOIN kelas ON dpt.id_kelas = kelas.id_kelas WHERE dpt.status = 3";
                        ...
                        <?php 
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <a href="dpt_hapus.php?id_dpt=<?php echo $data['id_dpt']?>" onclick="return confirm('Apakah anda yakin ingin menghapus data <?php echo $data['nm_dpt']?>?')"> <i class="fas fa-trash-alt"></i> </a> 
                                </td>
                            </tr>
                        <?php } ?>
                    </tbody>
